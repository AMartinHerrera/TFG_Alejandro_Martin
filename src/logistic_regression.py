...
print(f'The results have been written in the results folder/ -- The Logistic regression accuracy is (NO FILTERED DATA)--> %.4f'%accuracy + ' %')

f = open ('results/logistic_regression_with_NO_data_filter.data','a+')
f.write(f'Logistic regression accuracy is --> %.4f'%accuracy + ' %')
f.write('\n\n')
...
accuracy=100-errorTotal
print(f'The results have been written in the results folder/ -- The Logistic regression accuracy is (FILTERED DATA)--> %.4f'%accuracy + ' %')

f = open ('results/logistic_regression_with_data_filter.data','a+')
f.write(f'Logistic regression accuracy is --> %.4f'%accuracy + ' %')
f.write('\n\n')
f.write(str(df.to_string()))
